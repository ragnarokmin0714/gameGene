...
pub struct Tr {
    ...
    pub settle_hint: &'static str,
    pub reset: &'static str,
    pub matches: &'static str,
    pub results: &'static str,
    pub show_as: &'static str,
    pub show_as_scan: &'static str,
    pub show_as_hint: &'static str,
    pub as_types: &'static str,
    pub filter_title: &'static str,
    pub filter_addr: &'static str,
    pub filter_from: &'static str,
    pub filter_to: &'static str,
    pub filter_value: &'static str,
    pub filter_any: &'static str,
    pub filter_pos: &'static str,
    pub filter_neg: &'static str,
    pub filter_clear: &'static str,
    pub filter_note: &'static str,
