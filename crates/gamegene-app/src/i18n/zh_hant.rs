...
pub(super) static ZH: Tr = Tr {
    ...
    next_scan: "再次掃描",
    settle: "排除浮動",
    settle_hint: "只保留數值靜止的候選 —— 排除計時器、動畫、每幀重算等\n自己一直在變的位址。",
    reset: "重設",
    matches: "筆符合",
    results: "結果",
    show_as: "顯示為",
    show_as_scan: "同掃描型別",
    show_as_hint: "用另一種型別重新解讀同一批位元組。Int32 掃描也會找到正浮點數，所以顯示成 1157984256 的值其實可能是 2135.0f —— 切成 Float 就看得懂了。",
    as_types: "這些位元組解讀為：",
    filter_title: "篩選結果",
    filter_addr: "位址",
    filter_from: "起",
    ...
    filter_neg: "< 0",
    filter_clear: "清除篩選",
    filter_note: "只影響清單顯示，候選集合不變 —— 下一次掃描仍以全部候選為基礎。",
    no_scan: "尚未掃描。",
    add_table: "+ 加入表",
    ...
    load: "載入…",
    clear_all: "清除全部",
    clear_all_hint: "移除修改表中的所有項目",
    clear_all_confirm: "將移除的項目數：",
